...
//{
//    class DrawDetail : ISubSingleGraph
//    {
...
//            perbidList = (PerbidList)MainWindow.GetChildFromPanelByName(otherPanel, "perbidList");
//            //drawPerbidList = new PerbidList(perbidList);
//        }
...
//            {
//                stockId = _stockId;
//                BindData(DataLoader.GetRealTimeList().Select("stockId='" + stockId + "'")[0], DataLoader.GetSingleHistories(), DataLoader.GetSinglePerbid());
//            }
//        }
